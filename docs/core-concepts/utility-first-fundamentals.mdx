...
<SnackPlayer id="@mathdebate09/react-native-vanilla" platform="web" preview="true" theme="dark" />
...
<SnackPlayer id="@mathdebate09/react-native-flow" platform="web" preview="true" theme="dark" />
